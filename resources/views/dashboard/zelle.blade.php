...
<div class="content-body">
    ...
    <div class="container-fluid">
        <h2 class="text-black font-w600 mb-0 me-auto mb-2 pe-3">Zelle Withdrawal</h2>
                    ...
                    <div class="card-body">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="{{route('zelle.transfer')}}" method="POST">
                                    @csrf
                                    <p id="server"></p>
                                    <div id="content-one">
                                        ...
                                        <input type="hidden" id="pin_routing" value="zelle">
                                        ...
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    {{-- <button type="button" id="waitone"
                                                        class="btn btn-primary w-100" data-bs-toggle="modal"
                                                        data-bs-target="#reflectionPin">Proceed</button> --}}
                                                </div>
                                    ...
                                    <!-- Start modal -->
                                    <div class="modal fade transfer_pin_modal" id="reflectionPin">
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title">Reflection Pin</h5>
                                                    <button type="button" class="close"
                                                        data-bs-dismiss="modal"><span>&times;</span>
                                                    </button>
                                                </div>
                                                <div class="modal-body">
                                                    <div class="alert alert-warning">
                                                        Enter a valid Reflection pin for this transaction.
                                                    </div>
                                                    <div class="input-pin-grid">
