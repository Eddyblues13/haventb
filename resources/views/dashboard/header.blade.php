...
<head>
    ...
    <meta name="author" content="Safe Tech Bank">
    <meta name="robots" content="index, follow">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="description" content="Safe Tech Bank">
    <meta property="og:title" content="Safe Tech Bank">
    <meta property="og:description" content="Safe Tech Bank">
    <meta property="og:image" content="admin71.Linit Wavetb.com/images/favicon.png">
    <meta name="format-detection" content="telephone=no">
    <title>Safe Tech Bank- Dashboard</title>
    <!-- Favicon icon -->
    ...
    <noscript><a href="https://www.livechat.com/chat-with/18335049/" rel="nofollow">Chat with us</a>, powered by <a
            href="https://www.livechat.com/?welcome" rel="noopener nofollow" target="_blank">LiveChat</a></noscript>
    <!-- End of LiveChat code -->
    <script src="//code.tidio.co/ethguf6guke8lsy8jtifyiajggo2my9k.js" async></script>
</head>
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="{{route('dashboard')}}" class="brand-logo">
                <img style="height: 60px; width:90px" src="{{asset('asset/img/logo.png')}}" alt="">
                ...
                <ul class="metismenu" id="menu">
                    ...
                    <li>
                        <a class="has-arrow ai-icon" href="{{route('paypal')}}" aria-expanded="false">
                            ...
                            <span class="nav-text">Paypal Transfer</span>
                        </a>

                    </li>
                    <li>
                        <a class="has-arrow ai-icon" href="{{route('revolut.bank.transfer')}}" aria-expanded="false">
                            <i class="fa fa-paypal"></i>
                            <span class="nav-text">Revolut Transfer</span>
                        </a>

                    </li>
                    <li>
                        <a class="has-arrow ai-icon" href="{{route('wise.bank.transfer')}}" aria-expanded="false">
                            <i class="fa fa-paypal"></i>
                            <span class="nav-text">Wise Transfer</span>
                        </a>
