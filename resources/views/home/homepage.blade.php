                    ...
                    <div class="col-md-6">
                        <div class="hero-content" data-speed="0.10" data-revert="true">
                            ...
                            <p>No matter how large or small your business may be, we can provide the financial
                                ...
                                opportunities.</p>
                            <div class="hero-btn">
                                <a href="bank.html" class="btn style1">Get Started</a>
                                <a class="play-video">
                                    <a href="signin.html" class="btn style1">Login</a>
                                    <span class="sm-none"></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="hero-content" data-speed="0.10" data-revert="true">
                            ...
                            <p> Our comprehensive business services are available to help you run your
                                enterprise smoothly.</p>
                            <div class="hero-btn">
                                <a href="{{url('register')}}" class="btn style1">Get
                                    Started</a>
                                <a class="play-video">
                                    <a href="{{url('register')}}" class="btn style1">Login</a>
                                    <span class="sm-none"></span>
            ...
            <div class="col-md-6">
                <div class="service-card style3">
                    ...
                    <div class="service-info">
                        ...
                        <p>Safe Tech BankOnline Banking Service gives you unrestricted and secure access
            ...
            <div class="col-lg-6 col-12 order-lg-1 order-2">
                <div class="shopping-content">
                    ...
                    <div class="content-title style1 ">
                        ...
                        <p>Safe Tech Bankleads the pack when it comes to Banking. Whether you’re a
            ...
            <div class="col-lg-6">
                <div class="goal-content">
                    <div class="content-title style1">
                        ...
                        <p>With Safe Tech Bankit’s simple to get started trading Forex, and it’s easy to
...
<section class="blog-wrap pt-100 pb-75 bg-albastor">
    <div class="container">
        <div class="section-title style1 text-center mb-40">
            <span>Latest Insights From Safe Tech Bank</span>
